...
import WorldSvgMapForm from "../../components/forms/WorldSvgMapForm.vue";
...
function queueTerrainOverlayPersist() {
  ...
  terrainOverlayPersistTimer.value = setTimeout(() => {
    ...
    void persistWorldProfileToPlanetaryCatalog(world.value);
  }, 350);
}

function handleTerrainOverlayChange(nextOverlay) {
  if (!world.value || typeof world.value !== "object") {
    return;
  }

  world.value = {
    ...world.value,
    terrainOverlayBySize: nextOverlay && typeof nextOverlay === "object" ? nextOverlay : {},
  };
