      ...
      <div class="preferences-grid">
        ...
        <section class="card">
          ...
          <p class="section-copy">
            Choose how galaxy, sector, world, and asteroid belt names are generated by default. Clustered keeps nearby
            sectors, systems, and planets in the same local naming family.
          </p>
          ...
          <label class="field">
            ...
            <select v-model="draft.sectorNameMode">
              <option value="clustered">Clustered frontier</option>
              <option value="normalized">Normalized</option>
          ...
          <label class="field">
            <span>World naming mode</span>
            <select v-model="draft.worldNameMode">
              <option value="clustered">Clustered frontier</option>
              <option value="normalized">Normalized</option>
              <option value="list">Named list</option>
              <option value="phonotactic">Phonotactic</option>
          ...
          <label class="field">
            <span>Asteroid belt naming mode</span>
            <select v-model="draft.asteroidBeltNameMode">
              <option value="clustered">Clustered frontier</option>
              <option value="normalized">Normalized</option>
              <option value="phonotactic">Phonotactic</option>
              <option value="mythic">Mythic</option>
          ...
          <label class="field">
            <span>System naming mode</span>
            <select v-model="draft.systemNameMode">
              <option value="clustered">Clustered frontier</option>
              <option value="normalized">Normalized</option>
              <option value="mythic">Mythic</option>
              <option value="phonotactic">Phonotactic</option>
          ...
          <label class="field">
            <span>Append " System" suffix</span>
            <input type="checkbox" v-model="draft.appendSystemSuffix" />
            <p class="section-copy section-copy--compact">
              When enabled, generated system names will include a trailing " System" unless the name already ends with a
              known object noun (e.g. Belt, Cluster, Reach).
            </p>
          </label>
        </section>
...
function createDraft(source) {
  return {
    ...
    worldNameMode: String(source.worldNameMode || PREFERENCE_DEFAULTS.worldNameMode),
    asteroidBeltNameMode: String(source.asteroidBeltNameMode || PREFERENCE_DEFAULTS.asteroidBeltNameMode),
    ...
    systemNameMode: String(source.systemNameMode || PREFERENCE_DEFAULTS.systemNameMode),
    appendSystemSuffix: Boolean(source.appendSystemSuffix ?? PREFERENCE_DEFAULTS.appendSystemSuffix),
...
function savePreferences() {
  ...
  preferencesStore.replace({
    ...
    worldNameMode: draft.worldNameMode,
    asteroidBeltNameMode: draft.asteroidBeltNameMode,
    systemNameMode: draft.systemNameMode,
    ...
    appendSystemSuffix: Boolean(draft.appendSystemSuffix),
  });
